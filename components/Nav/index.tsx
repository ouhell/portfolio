...
const Nav = (props: Props) => {
  ...
  return (
    <nav className="fixed  h-10  lg:h-full flex justify-center items-center  w-full lg:w-fit bottom-0 lg:right-8 ">
        ...
        {navData.map((data) => {
          ...
          return (
            <Link key={data.name} href={data.path}>
              <div
                className={classNames("hover:text-orange-600  lg:p-2 ", {
